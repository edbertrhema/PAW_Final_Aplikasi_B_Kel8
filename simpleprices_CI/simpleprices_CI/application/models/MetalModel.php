...
class MetalModel extends CI_Model
{
    ...
    public function store($request)
    {
        ...
        $this->newRequest = $this->total;
        $this->newRequest = $this->post('total');

        if ($this->db->insert($this->table, $this) && $this->db->insert($this->global_table, $this->newRequest)) {
